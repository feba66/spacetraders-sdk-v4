...
class ExtractResourcesRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtractResourcesRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtractResourcesRequest:
        """Create an instance of ExtractResourcesRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtractResourcesRequest.parse_obj(obj)

        _obj = ExtractResourcesRequest.parse_obj({
            "survey": Survey.from_dict(obj.get("survey")) if obj.get("survey") is not None else None
        })
        return _obj
