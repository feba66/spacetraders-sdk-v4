...
class DeliverContract200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeliverContract200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeliverContract200ResponseData:
        """Create an instance of DeliverContract200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeliverContract200ResponseData.parse_obj(obj)

        _obj = DeliverContract200ResponseData.parse_obj(
            {
