...
class Faction(BaseModel):
    ...
    headquarters: constr(strict=True, min_length=1) = Field(
        default=..., description="The waypoint in which the faction's HQ is located in."
    )
    ...
    is_recruiting: StrictBool = Field(
        default=..., alias="isRecruiting", description="Whether or not the faction is currently recruiting new agents."
    )
        ...
        _obj = Faction.parse_obj(
            {
                ...
                "traits": (
                    [FactionTrait.from_dict(_item) for _item in obj.get("traits")] if obj.get("traits") is not None else None
                ),
