...
class SellCargo201ResponseData(BaseModel):
    """
    ...
    __properties = ["agent", "cargo", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SellCargo201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SellCargo201ResponseData:
        """Create an instance of SellCargo201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SellCargo201ResponseData.parse_obj(obj)

        _obj = SellCargo201ResponseData.parse_obj({
            ...
            "transaction": MarketTransaction.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
