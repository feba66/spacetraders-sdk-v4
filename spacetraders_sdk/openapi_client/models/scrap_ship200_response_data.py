...
class ScrapShip200ResponseData(BaseModel):
    ...
    __properties = ["agent", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScrapShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScrapShip200ResponseData:
        """Create an instance of ScrapShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScrapShip200ResponseData.parse_obj(obj)

        _obj = ScrapShip200ResponseData.parse_obj({
            "agent": Agent.from_dict(obj.get("agent")) if obj.get("agent") is not None else None,
            "transaction": ScrapTransaction.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
