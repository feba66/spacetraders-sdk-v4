...
class Agent(BaseModel):
    ...
    account_id: Optional[constr(strict=True, min_length=1)] = Field(
        default=None, alias="accountId", description="Account ID that is tied to this agent. Only included on your own agent."
    )
    ...
    starting_faction: constr(strict=True, min_length=1) = Field(
        default=..., alias="startingFaction", description="The faction the agent started with."
    )
