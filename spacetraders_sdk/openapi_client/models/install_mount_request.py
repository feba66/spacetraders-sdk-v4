...
class InstallMountRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstallMountRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstallMountRequest:
        """Create an instance of InstallMountRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstallMountRequest.parse_obj(obj)

        _obj = InstallMountRequest.parse_obj({"symbol": obj.get("symbol")})
        return _obj
