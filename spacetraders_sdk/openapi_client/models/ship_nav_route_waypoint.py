...
class ShipNavRouteWaypoint(BaseModel):
    """
    The destination or departure of a ships nav route.  # noqa: E501
    """
    ...
    __properties = ["symbol", "type", "systemSymbol", "x", "y"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShipNavRouteWaypoint:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShipNavRouteWaypoint:
        """Create an instance of ShipNavRouteWaypoint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShipNavRouteWaypoint.parse_obj(obj)

        _obj = ShipNavRouteWaypoint.parse_obj(
            {
