...
class SiphonResources201ResponseData(BaseModel):
    ...
    __properties = ["cooldown", "siphon", "cargo", "events"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SiphonResources201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SiphonResources201ResponseData:
