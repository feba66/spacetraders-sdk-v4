...
class FulfillContract200Response(BaseModel):
    ...
    data: AcceptContract200ResponseData = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FulfillContract200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FulfillContract200Response:
        """Create an instance of FulfillContract200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FulfillContract200Response.parse_obj(obj)

        _obj = FulfillContract200Response.parse_obj(
