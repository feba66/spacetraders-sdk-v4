...
class ShipRefine201ResponseData(BaseModel):
    ...
    produced: conlist(ShipRefine201ResponseDataProducedInner) = Field(
        default=..., description="Goods that were produced by this refining process."
    )
    consumed: conlist(ShipRefine201ResponseDataProducedInner) = Field(
        default=..., description="Goods that were consumed during this refining process."
    )
        ...
        _obj = ShipRefine201ResponseData.parse_obj(
            {
                ...
                "produced": (
                    [ShipRefine201ResponseDataProducedInner.from_dict(_item) for _item in obj.get("produced")]
                    if obj.get("produced") is not None
                    else None
                ),
                "consumed": (
                    [ShipRefine201ResponseDataProducedInner.from_dict(_item) for _item in obj.get("consumed")]
