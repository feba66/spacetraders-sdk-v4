...
class RepairShip200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RepairShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RepairShip200ResponseData:
        """Create an instance of RepairShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RepairShip200ResponseData.parse_obj(obj)

        _obj = RepairShip200ResponseData.parse_obj({
            ...
            "transaction": RepairTransaction.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
