...
class WaypointFaction(BaseModel):
    """
    The faction that controls the waypoint.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WaypointFaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WaypointFaction:
        """Create an instance of WaypointFaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WaypointFaction.parse_obj(obj)

        _obj = WaypointFaction.parse_obj({"symbol": obj.get("symbol")})
        return _obj
