...
class RemoveMountRequest(BaseModel):
    ...
    symbol: StrictStr = Field(default=..., description="The symbol of the mount to remove.")
    __properties = ["symbol"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RemoveMountRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RemoveMountRequest:
        """Create an instance of RemoveMountRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RemoveMountRequest.parse_obj(obj)

        _obj = RemoveMountRequest.parse_obj({"symbol": obj.get("symbol")})
        return _obj
