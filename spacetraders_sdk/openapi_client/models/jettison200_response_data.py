...
class Jettison200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Jettison200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Jettison200ResponseData:
        """Create an instance of Jettison200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Jettison200ResponseData.parse_obj(obj)

        _obj = Jettison200ResponseData.parse_obj(
