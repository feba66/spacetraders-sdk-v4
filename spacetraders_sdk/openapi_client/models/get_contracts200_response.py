...
class GetContracts200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetContracts200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetContracts200Response:
        """Create an instance of GetContracts200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetContracts200Response.parse_obj(obj)

        _obj = GetContracts200Response.parse_obj(
            {
                "data": [Contract.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
