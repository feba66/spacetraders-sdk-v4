...
class ShipyardShipTypesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShipyardShipTypesInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShipyardShipTypesInner:
        """Create an instance of ShipyardShipTypesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShipyardShipTypesInner.parse_obj(obj)

        _obj = ShipyardShipTypesInner.parse_obj({"type": obj.get("type")})
        return _obj
