...
class CreateShipWaypointScan201ResponseData(BaseModel):
    ...
    waypoints: conlist(ScannedWaypoint) = Field(default=..., description="List of scanned waypoints.")
    __properties = ["cooldown", "waypoints"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateShipWaypointScan201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateShipWaypointScan201ResponseData:
        """Create an instance of CreateShipWaypointScan201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateShipWaypointScan201ResponseData.parse_obj(obj)

        _obj = CreateShipWaypointScan201ResponseData.parse_obj({
            "cooldown": Cooldown.from_dict(obj.get("cooldown")) if obj.get("cooldown") is not None else None,
            "waypoints": [ScannedWaypoint.from_dict(_item) for _item in obj.get("waypoints")] if obj.get("waypoints") is not None else None
        })
        return _obj
