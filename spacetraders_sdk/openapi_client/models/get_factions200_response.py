...
class GetFactions200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetFactions200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetFactions200Response:
        """Create an instance of GetFactions200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetFactions200Response.parse_obj(obj)

        _obj = GetFactions200Response.parse_obj(
            {
                "data": [Faction.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
