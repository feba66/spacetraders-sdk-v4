...
class JettisonRequest(BaseModel):
    ...
    units: conint(strict=True, ge=1) = Field(default=..., description="Amount of units to jettison of this good.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JettisonRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JettisonRequest:
        """Create an instance of JettisonRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JettisonRequest.parse_obj(obj)

        _obj = JettisonRequest.parse_obj({"symbol": obj.get("symbol"), "units": obj.get("units")})
        return _obj
