...
class Register201ResponseData(BaseModel):
    ...
    ship: Ship = Field(...)
    token: StrictStr = Field(default=..., description="A Bearer token for accessing secured API endpoints.")
    __properties = ["agent", "contract", "faction", "ship", "token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Register201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Register201ResponseData:
        """Create an instance of Register201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Register201ResponseData.parse_obj(obj)

        _obj = Register201ResponseData.parse_obj(
            {
