...
class GetSystemWaypointsTraitsParameter(BaseModel):
    ...
    oneof_schema_2_validator: Optional[conlist(WaypointTraitSymbol)] = None
    if TYPE_CHECKING:
        actual_instance: Union[List[WaypointTraitSymbol], WaypointTraitSymbol]
    else:
        actual_instance: Any
    one_of_schemas: List[str] = Field(GETSYSTEMWAYPOINTSTRAITSPARAMETER_ONE_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = GetSystemWaypointsTraitsParameter.construct()
        error_messages = []
        match = 0
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetSystemWaypointsTraitsParameter:
        return cls.from_json(json.dumps(obj))

    @classmethod
    def from_json(cls, json_str: str) -> GetSystemWaypointsTraitsParameter:
