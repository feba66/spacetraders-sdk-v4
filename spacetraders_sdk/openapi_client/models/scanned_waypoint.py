...
class ScannedWaypoint(BaseModel):
    ...
    __properties = ["symbol", "type", "systemSymbol", "x", "y", "orbitals", "faction", "traits", "chart"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScannedWaypoint:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScannedWaypoint:
