...
class WaypointModifier(BaseModel):
    ...
    symbol: WaypointModifierSymbol = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WaypointModifier:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WaypointModifier:
        """Create an instance of WaypointModifier from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WaypointModifier.parse_obj(obj)

        _obj = WaypointModifier.parse_obj(
