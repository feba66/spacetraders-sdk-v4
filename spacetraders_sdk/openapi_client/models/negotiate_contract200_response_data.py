...
class NegotiateContract200ResponseData(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NegotiateContract200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NegotiateContract200ResponseData:
        """Create an instance of NegotiateContract200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NegotiateContract200ResponseData.parse_obj(obj)

        _obj = NegotiateContract200ResponseData.parse_obj({
