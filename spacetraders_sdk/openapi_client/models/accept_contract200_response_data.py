...
class AcceptContract200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AcceptContract200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AcceptContract200ResponseData:
        """Create an instance of AcceptContract200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AcceptContract200ResponseData.parse_obj(obj)

        _obj = AcceptContract200ResponseData.parse_obj({
