...
class NavigateShip200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NavigateShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NavigateShip200ResponseData:
        """Create an instance of NavigateShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NavigateShip200ResponseData.parse_obj(obj)

        _obj = NavigateShip200ResponseData.parse_obj(
            {
