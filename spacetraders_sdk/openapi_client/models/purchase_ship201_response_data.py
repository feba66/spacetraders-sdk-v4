...
class PurchaseShip201ResponseData(BaseModel):
    ...
    __properties = ["agent", "ship", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseShip201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseShip201ResponseData:
        """Create an instance of PurchaseShip201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseShip201ResponseData.parse_obj(obj)

        _obj = PurchaseShip201ResponseData.parse_obj({
            ...
            "transaction": ShipyardTransaction.from_dict(obj.get("transaction")) if obj.get("transaction") is not None else None
        })
        return _obj
