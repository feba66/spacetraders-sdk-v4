...
class GetScrapShip200ResponseData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetScrapShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetScrapShip200ResponseData:
        """Create an instance of GetScrapShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetScrapShip200ResponseData.parse_obj(obj)

        _obj = GetScrapShip200ResponseData.parse_obj(
