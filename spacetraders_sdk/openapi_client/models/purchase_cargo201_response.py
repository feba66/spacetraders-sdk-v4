...
class PurchaseCargo201Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseCargo201Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseCargo201Response:
        """Create an instance of PurchaseCargo201Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseCargo201Response.parse_obj(obj)

        _obj = PurchaseCargo201Response.parse_obj({
