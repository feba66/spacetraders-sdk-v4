...
class WaypointTrait(BaseModel):
    ...
    symbol: WaypointTraitSymbol = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WaypointTrait:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WaypointTrait:
        """Create an instance of WaypointTrait from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WaypointTrait.parse_obj(obj)

        _obj = WaypointTrait.parse_obj(
