...
class ExtractResources201ResponseData(BaseModel):
    ...
    events: conlist(ExtractResources201ResponseDataEventsInner) = Field(...)
    __properties = ["cooldown", "extraction", "cargo", "events"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExtractResources201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExtractResources201ResponseData:
        """Create an instance of ExtractResources201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExtractResources201ResponseData.parse_obj(obj)

        _obj = ExtractResources201ResponseData.parse_obj({
            "cooldown": Cooldown.from_dict(obj.get("cooldown")) if obj.get("cooldown") is not None else None,
            "extraction": Extraction.from_dict(obj.get("extraction")) if obj.get("extraction") is not None else None,
