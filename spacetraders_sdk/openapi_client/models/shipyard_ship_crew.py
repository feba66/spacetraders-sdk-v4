...
class ShipyardShipCrew(BaseModel):
    ...
    __properties = ["required", "capacity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ShipyardShipCrew:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ShipyardShipCrew:
        """Create an instance of ShipyardShipCrew from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ShipyardShipCrew.parse_obj(obj)

        _obj = ShipyardShipCrew.parse_obj({"required": obj.get("required"), "capacity": obj.get("capacity")})
        return _obj
