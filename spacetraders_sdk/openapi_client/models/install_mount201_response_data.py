...
class InstallMount201ResponseData(BaseModel):
    ...
    """
    agent: Agent = Field(...)
    mounts: conlist(ShipMount) = Field(default=..., description="List of installed mounts after the installation of the new mount.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstallMount201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstallMount201ResponseData:
        """Create an instance of InstallMount201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstallMount201ResponseData.parse_obj(obj)

        _obj = InstallMount201ResponseData.parse_obj({
