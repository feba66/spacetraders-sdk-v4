...
class SystemFaction(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SystemFaction:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SystemFaction:
        """Create an instance of SystemFaction from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SystemFaction.parse_obj(obj)

        _obj = SystemFaction.parse_obj({"symbol": obj.get("symbol")})
        return _obj
