...
class ScannedShipEngine(BaseModel):
    """
    The engine of the ship.  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScannedShipEngine:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScannedShipEngine:
        """Create an instance of ScannedShipEngine from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ScannedShipEngine.parse_obj(obj)

        _obj = ScannedShipEngine.parse_obj({"symbol": obj.get("symbol")})
        return _obj
