...
class RegisterRequest(BaseModel):
    ...
    faction: FactionSymbol = Field(...)
    symbol: constr(strict=True, max_length=14, min_length=3) = Field(
        default=...,
    ...
    email: Optional[StrictStr] = Field(
        default=None, description="Your email address. This is used if you reserved your call sign between resets."
    )
    __properties = ["faction", "symbol", "email"]
    ...
    def from_dict(cls, obj: dict) -> RegisterRequest:
        ...
        _obj = RegisterRequest.parse_obj(
            {"faction": obj.get("faction"), "symbol": obj.get("symbol"), "email": obj.get("email")}
        )
        return _obj
