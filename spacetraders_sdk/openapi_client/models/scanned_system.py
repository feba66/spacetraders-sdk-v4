...
class ScannedSystem(BaseModel):
    ...
    distance: StrictInt = Field(default=..., description="The system's distance from the scanning ship.")
    __properties = ["symbol", "sectorSymbol", "type", "x", "y", "distance"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ScannedSystem:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ScannedSystem:
