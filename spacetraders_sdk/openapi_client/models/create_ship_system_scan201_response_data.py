...
class CreateShipSystemScan201ResponseData(BaseModel):
    ...
    systems: conlist(ScannedSystem) = Field(default=..., description="List of scanned systems.")
    __properties = ["cooldown", "systems"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateShipSystemScan201ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateShipSystemScan201ResponseData:
        """Create an instance of CreateShipSystemScan201ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateShipSystemScan201ResponseData.parse_obj(obj)

        _obj = CreateShipSystemScan201ResponseData.parse_obj({
            "cooldown": Cooldown.from_dict(obj.get("cooldown")) if obj.get("cooldown") is not None else None,
            "systems": [ScannedSystem.from_dict(_item) for _item in obj.get("systems")] if obj.get("systems") is not None else None
        })
        return _obj
