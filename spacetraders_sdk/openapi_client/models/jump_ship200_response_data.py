...
class JumpShip200ResponseData(BaseModel):
    ...
    agent: Agent = Field(...)
    __properties = ["nav", "cooldown", "transaction", "agent"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> JumpShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> JumpShip200ResponseData:
        """Create an instance of JumpShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return JumpShip200ResponseData.parse_obj(obj)

        _obj = JumpShip200ResponseData.parse_obj({
