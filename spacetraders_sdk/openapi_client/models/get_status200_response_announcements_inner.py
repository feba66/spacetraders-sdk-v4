...
class GetStatus200ResponseAnnouncementsInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetStatus200ResponseAnnouncementsInner:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetStatus200ResponseAnnouncementsInner:
        """Create an instance of GetStatus200ResponseAnnouncementsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetStatus200ResponseAnnouncementsInner.parse_obj(obj)

        _obj = GetStatus200ResponseAnnouncementsInner.parse_obj({"title": obj.get("title"), "body": obj.get("body")})
        return _obj
