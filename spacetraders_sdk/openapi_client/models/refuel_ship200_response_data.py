...
class RefuelShip200ResponseData(BaseModel):
    ...
    __properties = ["agent", "fuel", "transaction"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RefuelShip200ResponseData:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RefuelShip200ResponseData:
        """Create an instance of RefuelShip200ResponseData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RefuelShip200ResponseData.parse_obj(obj)

        _obj = RefuelShip200ResponseData.parse_obj({
