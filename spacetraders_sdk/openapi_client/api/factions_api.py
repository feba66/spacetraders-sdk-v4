...
class FactionsApi:
    ...
    def get_faction(
        ...
        **kwargs,
        ...
        >>> thread = api.get_faction(faction_symbol, async_req=True)
        >>> result = thread.get()
    ...
    def get_faction_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_faction_with_http_info(faction_symbol, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetFaction200Response, status_code(int), headers(HTTPHeaderDict))
        """
    ...
    def get_factions(
        ...
        **kwargs,
        ...
        >>> thread = api.get_factions(page, limit, async_req=True)
        >>> result = thread.get()
    ...
    def get_factions_with_http_info(
        ...
        **kwargs,
        ...
        >>> thread = api.get_factions_with_http_info(page, limit, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetFactions200Response, status_code(int), headers(HTTPHeaderDict))
        """
